...
data State = State
  ...
  , embedCells :: Map UUID (Tuple UUID Unit -- HTMLElement
                           )
  }
...
data Command
  ...
  | RegisterWidget UUID UUID Unit -- HTMLElement
...
component editorComponent =
  ...
  where
    ...
    initialState cells = State {
      allCells: cells,
      embedCells:
      M.fromFoldable [Tuple (UUID "some-unique-id") (Tuple (UUID "7190914a-9a54-477b-b5dc-da6b73edb7c9") unit)]
     }
