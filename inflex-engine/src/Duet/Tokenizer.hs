...
tokenStr tok =
  case tok of
    If -> curlyQuotes "if"
    Colon -> "colon "++ curlyQuotes ":"
    OpenCurly -> "left curly bracket "++ curlyQuotes "{"
    CloseCurly -> "right curly bracket "++ curlyQuotes "}"
    ...
    OpenParen -> "opening round bracket " ++ curlyQuotes "("
    CloseParen -> "closing round bracket " ++ curlyQuotes ")"
    OpenBracket -> "opening square bracket " ++ curlyQuotes "["
    CloseBracket -> "closing square bracket " ++ curlyQuotes "]"
    Equals -> curlyQuotes "="
    Colons -> curlyQuotes "::"
