...
CREATe TABLE "cell"("id" SERIAL8  PRIMARY KEY UNIQUE,"account" INT8 NOT NULL,"document" INT8 NOT NULL,"code" INT8 NOT NULL,"created" TIMESTAMP WITH TIME ZONE NOT NULL,"name" VARCHAR NOT NULL,"uuid" VARCHAR NOT NULL);

CREATe TABLE "code"("id" SERIAL8  PRIMARY KEY UNIQUE,"source" VARCHAR NOT NULL,"hash" BYTEA NOT NULL,"created" TIMESTAMP WITH TIME ZONE NOT NULL);
